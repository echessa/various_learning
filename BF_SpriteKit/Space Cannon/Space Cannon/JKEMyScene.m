...
static const CGFloat kJKEShootSpeed = 1000.0f;
static const CGFloat kJKEHaloLowAngle = 200.0 * M_PI / 180.0;
static const CGFloat kJKEHaloHighAngle = 340.0 * M_PI / 180.0;
static const CGFloat kJKEHaloSpeed = 180.0;
...
-(void)shoot
{
    ...
    ball.physicsBody.velocity = CGVectorMake(rotationVector.dx * kJKEShootSpeed, rotationVector.dy * kJKEShootSpeed);
...
-(void)spawnHalo
{
    ...
    CGVector direction = radiansToVector(randomInRange(kJKEHaloLowAngle, kJKEHaloHighAngle));
    halo.physicsBody.velocity = CGVectorMake(direction.dx * kJKEHaloSpeed, direction.dy * kJKEHaloSpeed);
